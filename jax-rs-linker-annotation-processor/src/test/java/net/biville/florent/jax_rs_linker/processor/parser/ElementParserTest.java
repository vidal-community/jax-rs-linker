...
public class ElementParserTest {
    ...
    public void parses_method_to_mapping_representation() {
        ExecutableElement method = methodElements.of(
            "net.biville.florent.jax_rs_linker.processor.parser.ProductResource",
            "productById"
        );
        ...
        assertThat(javaLocation.getClassName().getName())
            .isEqualTo("net.biville.florent.jax_rs_linker.processor.parser.ProductResource");
    ...
    public void fails_to_parse_because_of_absence_of_path() {
        ExecutableElement method = methodElements.of(
            "net.biville.florent.jax_rs_linker.processor.parser.UnparseableResource",
            "methodWithoutPath"
        );
        ...
        String errorMessage =
            "\n\tNo path could be found. \n" +
                ...
                "\tGiven method: <net.biville.florent.jax_rs_linker.processor.parser.UnparseableResource#methodWithoutPath>";
    ...
    public void fails_to_parse_because_of_absence_of_jax_rs_http_verb_annotation() {
        ...
        String errorMessage =
            "\n\tNo JAX-RS HTTP verb annotation found (e.g. @GET, @POST...).\n" +
                "\tGiven method: <net.biville.florent.jax_rs_linker.processor.parser.UnparseableResource#methodWithoutHttpVerb>";
        assertThat(mapping.isPresent()).isFalse();
        verify(messager).printMessage(ERROR, errorMessage, method);
    }
    ...
    public void fails_to_parse_because_no_link_type_annotation_is_present() {
        ...
        String errorMessage =
            "\n\tMethod should be annotated with exactly one annotation: @Self or @SubResource.\n" +
                "\tGiven method: <net.biville.florent.jax_rs_linker.processor.parser.UnparseableResource#methodWithoutLinkTypes>";
        assertThat(mapping.isPresent()).isFalse();
        verify(messager).printMessage(ERROR, errorMessage, method);
    }
    ...
    public void fails_to_parse_because_too_many_link_type_annotations_are_present() {
        ...
        String errorMessage =
            "\n\tMethod should be annotated with exactly one annotation: @Self or @SubResource.\n" +
                "\tGiven method: <net.biville.florent.jax_rs_linker.processor.parser.UnparseableResource#methodWithTooManyLinkTypes>";
        assertThat(mapping.isPresent()).isFalse();
        verify(messager).printMessage(ERROR, errorMessage, method);
    }
}