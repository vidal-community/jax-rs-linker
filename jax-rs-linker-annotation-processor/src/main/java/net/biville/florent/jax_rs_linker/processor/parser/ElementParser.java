...
import static net.biville.florent.jax_rs_linker.processor.errors.Messages.*;
import static net.biville.florent.jax_rs_linker.processor.predicates.ElementHasAnnotation.BY_ANNOTATION;
